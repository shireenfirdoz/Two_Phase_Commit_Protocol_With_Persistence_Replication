...
CMN_SRCS := $(filter-out $(SVR_SRCS) $(CLNT_SRCS) TransactionManager.cpp Experimental.cpp, $(SRCS))
...
TARGET := server client tm experiment
...
server: $(SVR_OBJS) $(CMN_OBJS) ClientStub.o ClientSocket.o
	$(CXX) $(LFLAGS) -o $@ $^
...
tm: TransactionManager.cpp ServerSocket.o ClientSocket.o Socket.o ServerStub.o ClientStub.o Messages.o
	$(CXX) $(LFLAGS) $(CFLAGS) -o $@ $^

experiment: Experimental.cpp ServerSocket.o ClientSocket.o Socket.o ServerStub.o ClientStub.o Messages.o ClientThread.o ClientTimer.o
	$(CXX) $(LFLAGS) $(CFLAGS) -o $@ $^
...
clean:
	rm -rf *.o $(TARGET) custRecFile.txt logFile.txt
